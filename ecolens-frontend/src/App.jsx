            ...
            >
              <div className="bg-[#f0f5f0] p-6 rounded-lg shadow-lg max-w-sm w-full text-center carousel-card">
                ...
                <h3 className="text-xl font-poppins font-semibold text-[#1a2c1a] mb-2">
                  {ecoChampions[currentChampion].name}
                </h3>
                <p className="text-sm font-poppins text-[#2f3b2f] mb-3">
                  {ecoChampions[currentChampion].bio}
                </p>
                ...
                <div className="flex items-center justify-center mb-4">
                  ...
                  <p className="text-sm font-poppins font-medium text-[#88a978]">
                    {ecoChampions[currentChampion].stat}
                  </p>
                </div>
                ...
                <div className="relative w-24 h-24 mx-auto mb-4">
                  <svg className="w-full h-full" viewBox="0 0 36 36">
                    ...
                    <path
                      ...
                      stroke="#88a978"
                      strokeWidth="3"
                      strokeDasharray={`${(ecoChampions[currentChampion].statValue / ecoChampions[currentChampion].statGoal) * 100}, 100`}
                    />
                  </svg>
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-sm font-poppins text-[#1a2c1a]">
                      {Math.round((ecoChampions[currentChampion].statValue / ecoChampions[currentChampion].statGoal) * 100)}%
                    </span>
                  </div>
                </div>
                ...
                <AnimatePresence>
                  {openDropdown === currentChampion && (
                    ...
                    >
                      {ecoChampions[currentChampion].details}
                    </motion.div>
                  )}
                </AnimatePresence>
              </div>
